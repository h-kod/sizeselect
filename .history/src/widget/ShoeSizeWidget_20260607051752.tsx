    ...
    <div>
      <Drawer open={open} onClose={()=>{setOpen(false); console.log('event','widget_closed')}}>
        <div className="ssw-stepper">
          <span className="ssw-step active">Marka</span>
          <span className="ssw-step">Beden</span>
          <span className="ssw-step">Fit</span>
        </div>

        <div className="ssw-section">
          <label className="ssw-label">Hedef marka</label>
          <div className="ssw-chip" style={{marginBottom:12}}>{selectedTargetBrand}</div>
        ...
        <div className="ssw-section" style={{display:'flex',justifyContent:'space-between',alignItems:'center',gap:12}}>
